...
/************************************************************/
class DistroWorkPackage {
public:
    DistroWorkPackage(char* type) {
...
public:
    ...
    DistroWorkPackage* getResult() {
        return _result;
    }
protected:
    DistroWorkPackage* _result;
};

class UnixBuilder : public Builder {
public:
    UnixBuilder() {
        _result = new DistroWorkPackage("Unix");
    }
...
public:
    VmsBuilder() {
        _result = new DistroWorkPackage("Vms");
    }
    void configureFile(char* name) {
